            ...
            '<td>'.
                '<div class="row">'.
                    ...
                    '<div class="col-xs-5 col-sm-5 col-md-6 col-lg-5 text-center">'.
                        ...
                        '<a onclick="return confirm('."'¿Estas seguro que deseas eliminar este edificio? Los salones y horarios relacionados con el tambien seran eliminados'".');" href="'.site_url('Building/delete/'.$key->id) .'"><i class="fa fa-trash-o fa-fw eliminar" title="Eliminar"></i></a>'.
                    '</div>'.
                '</div>'.
            '</td>';
        }
